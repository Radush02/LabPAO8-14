...
import org.example.lab10.dic.CustomContainer;
import org.example.lab10.dic.CustomContainerImpl;
...
public abstract class TaskTestsBase {
    ...
    protected void assertExceptionMessage(Executable executable, String exceptionMessage) {
        {
            RuntimeException e =
                    assertThrows(RuntimeException.class, executable, "Exception should be thrown");
