...
public class Task1Tests extends TaskTestsBase {
    ...
    void testAddInstanceThrowsExceptionOnDuplicate() {
        ...
        assertExceptionMessage(
                () -> customContainer.addInstance(objToAdd), "Instances cannot be redeclared");
    }
    ...
    void testAddInstanceThrowsExceptionOnDifferentObjectsOfSameClass() {
        ...
        assertExceptionMessage(
                () -> customContainer.addInstance(objToAdd2), "Instances cannot be redeclared");
    }
    ...
    void testAddInstanceThrowsExceptionOnDifferentObjects() {
        ...
        assertExceptionMessage(
                () -> customContainer.addInstance(objToAdd2, "customName"),
                "Instances cannot be redeclared");
    }
    ...
    static Stream<Arguments> testAddInstanceReturnsTrueData() {
        return Stream.of(
                ...
                Arguments.of(
                        List.of(new Object(), 5, true, "5", new byte[0], new StringTokenizer(""))));
    }
}
